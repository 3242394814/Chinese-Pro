if GLOBAL.TheNet:GetLocalUserName() then
    if GLOBAL.TheNet:GetLocalUserName() == "踏雪寻梅3124" then playername = "梅老板" end
    playername = GLOBAL.TheNet:GetLocalUserName()--playername = 玩家名称 （目前还不知道如何将它设置为仇恨目标）
else
    return print("Chinese++ Pro-梅式猪人语言包:错误-无法获取到任何昵称")
end
...
STRINGS.PIG_TALK_FIND_LIGHT = { "好可怕", "我怕黑", "太阳在哪？", "待在火旁", "烤火美滋滋！" }
...
STRINGS.PIG_TALK_GO_HOME = { "回家玩饥荒了！", "回家去看梅老板直播！" }
