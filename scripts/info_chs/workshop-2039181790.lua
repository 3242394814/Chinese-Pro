...
description = string.gsub(description,"Alpha Goats will appear in goat herds, to protect their own, and have consistant loot.","阿尔法伏特羊将出现在山羊群中，保护它们自己，并拥有一致的战利品。")
